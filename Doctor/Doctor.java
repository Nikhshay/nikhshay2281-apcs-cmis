...
public class Doctor extends Senior
{
    ...
    public Doctor(String name, String yob, String mob, String dob, String schoolName, String university, boolean gapYear, String typeofdoctor, int yearsofexperience)
    {
